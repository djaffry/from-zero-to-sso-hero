...
describe('OidcService', () => {
  ...
  beforeEach(() => {
    ...
    mockLocation.href = 'http://localhost:8050';
  ...
  describe('logout', () => {
    it('should redirect to end session endpoint with correct parameters when user has id token', async () => {
      ...
      expect(window.location.href).toContain('localhost%3A8050%2Flogout-callback');
  ...
  describe('handleOidcCallback', () => {
    it('should handle login callback correctly', async () => {
      // Arrange
      const callbackUrl = 'http://localhost:8050/callback?code=mock-code&state=mock-state';
    ...
    it('should handle logout callback correctly', async () => {
      // Arrange
      const callbackUrl = 'http://localhost:8050/logout-callback';
    ...
    it('should do nothing for non-callback URLs', async () => {
      // Arrange
      const nonCallbackUrl = 'http://localhost:8050/some-other-page';
